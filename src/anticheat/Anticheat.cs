...
namespace MalumMenu.anticheat
{
    internal class Anticheat
    {
        ...
        public static void Flag(PlayerControl player, string reason, bool shouldPunish = true)
        {
            if (sendNotification)
            {
                ConsoleUI.Log("Anticheat Notice:");
                ConsoleUI.Log(reason);
            }
        ...
        private static void Punish(PlayerControl player)
        {
            switch (punishment)
            {
                ...
                case Punishments.ErrorKick:
                    ConsoleUI.Log($"{player.Data.PlayerName} was kicked by HyperMenu Anticheat for hacking");
                ...
                case Punishments.Ban:
                    ConsoleUI.Log($"{player.Data.PlayerName} was automatically banned by Hydra Anticheat for hacking");
